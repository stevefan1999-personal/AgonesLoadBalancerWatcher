...
public static class GameServerLoadBalancerExtension
{
    ...
    public static bool IsCiliumLoadBalancerEnabledFromAnnotation(this GameServer gameServer) =>
        gameServer.Annotations().TryGetValue(CiliumLoadBalancerEnabledKey, out var valueStr)
    ...
    public static string? GetCiliumLoadBalancerSharingKeyFromAnnotation(
    ...
    public static string? GetCiliumLoadBalancerSharingAcrossNamespaceFromAnnotation(
        this GameServer gameServer
    ...
    public static string? GetCiliumLoadBalancerServiceGeneratedName(this GameServer gameServer) =>
        gameServer.IsCiliumLoadBalancerEnabledFromAnnotation()
