...
public static class GameServerEgressGatewayPolicyExtension
{
    ...
    public static bool IsCiliumEgressGatewayPolicyEnabledFromAnnotation(
        this GameServer gameServer
    ) =>
        gameServer.Annotations().TryGetValue(CiliumEgressGatewayPolicyEnabledKey, out var valueStr)
    ...
    public static string? GetCiliumEgressGatewayPolicyGeneratedName(this GameServer gameServer) =>
        gameServer.IsCiliumEgressGatewayPolicyEnabledFromAnnotation()
    ...
    public static bool AttachCiliumEgressGatewayPolicyFinalizer(this GameServer gameServer) =>
        gameServer.AddFinalizer(CiliumEgressGatewayPolicyFinalizerKey);
}
